...
export let cheatNames = [
  // DYNAMIC RESOLUTION
  { 
    cvar: "r.DynamicRes.OperationMode", 
    name: "Dynamic Resolution", 
    options: toggleOptions
  },
  { 
    cvar: "r.DynamicRes.FrameTimeBudget", 
    name: "Dynamic Resolution Target FPS", 
    option: fpsTargetOptions
  },
  // ANTI ALIASING
  {
    cvar: "r.DefaultFeature.AntiAliasing",
    name: "Set Anti-Aliasing",
    options: levels
  },
  { 
  ...
  */
  ...
  { 
    cvar: "r.SecondaryScreenPercentage.GameViewport", 
    name: "2nd Render Resolution", 
    options: resPercentageOptions 
  },
  // UPSCALE
  { 
    cvar: "r.Upscale.Quality", 
  ...
  // VIEW DISTANCE
  { 
    cvar: "r.ViewDistanceScale", 
    name: "View Distance Scale", 
    options: levelOptions.slice(0, -2)
  },
  { 
    cvar: "foliage.LODDistanceScale", 
    name: "Foliage", 
    options: levelOptions
  },
  // EFFECTS
  { 
    cvar: "r.AmbientOcclusionRadiusScale", 
    name: "SSAO", 
    options: levelOptions
  },
  { 
    cvar: "r.ShadowQuality", 
    name: "Shadow", 
    options: levels.slice(0, -2)
  },
  { 
    cvar: "r.Shadow.DistanceScale", 
  ...
  { 
    cvar: "r.SceneColorFringeQuality", 
    name: "Chromatic Aberration", 
    options: toggleOptions 
  },
  { 
    cvar: "r.DepthOfFieldQuality", 
    name: "Depth of Field", 
    options: toggleOptions
  },
